const curriculum = [
    ...
    contents: [
            ...
            firstSem:[
                {subjCode:"GEC103",subjName:"Understanding the Self", duration: 3, classType: "lec", expertiseReq:"General Education"},
                {subjCode:"GEC102",subjName:"Mathematics in the Modern World", duration: 3, classType: "lec", expertiseReq:"Mathematics"},
                {subjCode:"CSS113",subjName:"Advanced PC Trouble Shooting", duration: 3, classType: "Lab", expertiseReq:"Hardware"},
                {subjCode:"CC113-1",subjName:"Introduction to Computing with Productivity Tools", duration: 3, classType: "lab", expertiseReq:"Programming"},
                {subjCode:"CC113-2",subjName:"Computer Programming 1", duration: 3, classType: "lab", expertiseReq:"Programming"},
                {subjCode:"BP113",subjName:"Basic Photography", duration: 3, classType: "lec", expertiseReq:"Photography"},
                {subjCode:"PE101",subjName:"Physical Fitness 1", duration: 3, classType: "gym", expertiseReq:"Physical Education"},
                {subjCode:"NSTP1",subjName:"National Service Training Program 1", duration: 3, classType: "out", expertiseReq:"General Education"}
            ],
            ...
            firstSem:[
                {subjCode:"GEC107",subjName:"Art Appreciation", duration: 3, classType: "lec", expertiseReq:"General Education"},
                {subjCode:"GEC101",subjName:"Purposive Communication", duration: 3, classType: "lab", expertiseReq:"General Education"},
                {subjCode:"NET213",subjName:"Networking 1", duration: 3, classType: "lab", expertiseReq:"Networking"},
                {subjCode:"CC213-1",subjName:"Data Structures & Algorithms", duration: 3, classType: "lec", expertiseReq:"Computer Science"},
                {subjCode:"CC213-2",subjName:"Information Management 1", duration: 3, classType: "lab", expertiseReq:"Database"},
                {subjCode:"GAD213",subjName:"2D and 3D Digital Enimation", duration: 3, classType: "lab", expertiseReq:"Animation"},
                {subjCode:"PE103",subjName:"Physical Fitness 3", duration: 3, classType: "gym", expertiseReq:"Physical Education"}
            ...
            secondSem:[
                {subjCode:"GEC105",subjName:"Science, Technology, and Society", duration: 3, classType: "lec", expertiseReq:"General Education"},
                {subjCode:"GEC106",subjName:"The Contemporary World", duration: 3, classType: "lec", expertiseReq:"General Education"},
                {subjCode:"MC223",subjName:"Mobile Computing", duration: 3, classType: "lab", expertiseReq:"Programming"},
                {subjCode:"NET223",subjName:"Networking 2", duration: 3, classType: "lab", expertiseReq:"Networking"},
                {subjCode:"IM223",subjName:"Fundamentals of Database Systems", duration: 3, classType: "lab", expertiseReq:"Database"},
                {subjCode:"ELEC223",subjName:"IT Elective 1", duration: 3, classType: "Lab", expertiseReq:"Computer Science"},
                {subjCode:"PE104",subjName:"Physical Fitness 4", duration: 3, classType: "gym", expertiseReq:"Physical Education"}
            ]
            },
            {level:"3rd_year",
            firstSem:[
                {subjCode:"FIL101",subjName:"Kontekstwalizasong Komunikasyon sa Filipino", duration: 3, classType: "lec", expertiseReq:"General Education"},
                {subjCode:"SA313",subjName:"System Administration & Maintenance", duration: 3, classType: "lab", expertiseReq:"Networking"},
                {subjCode:"SAD313",subjName:"Systems Analysis, Design and Development", duration: 3, classType: "lab", expertiseReq:"Software Engineering"},
                {subjCode:"ELEC313",subjName:"IT Elective 2", duration: 3, classType: "lab", expertiseReq:"Computer Science"},
                {subjCode:"CC313",subjName:"Application Dev't and Emerging Technologies", duration: 3, classType: "Lab", expertiseReq:"Web Development"},
                {subjCode:"IPT313",subjName:"Integrative Prog'g & Technologies 1", duration: 3, classType: "lab", expertiseReq:"Computer Science"}
            ],
            secondSem:[
                {subjCode:"FIL103",subjName:"Panitikan", duration: 3, classType: "lec", expertiseReq:"General Education"},
                {subjCode:"CAP323",subjName:"Capstone Project and Research 1", duration: 3, classType: "lab", expertiseReq:"Computer Science"},
                {subjCode:"IAS323",subjName:"Information Assurance & Security 1", duration: 3, classType: "lec", expertiseReq:"Cybersecurity"},
                {subjCode:"SIA323",subjName:"Systems Integration & Architecture 1", duration: 3, classType: "lab", expertiseReq:"Hardware"},
                {subjCode:"ELEC323",subjName:"IT Elective 3", duration: 3, classType: "lab", expertiseReq:"Computer Science"},
                {subjCode:"MS313",subjName:"Quantitative Methods (Modeling & SImulation)", duration: 3, classType: "lab", expertiseReq:"Computer Science"},
            ]
            },
            {level:"4th_year",
            firstSem:[
                ...
                {subjCode:"ELEC413",subjName:"IT Elective 4", duration: 3, classType: "lab", expertiseReq:"Computer Science"},
            ...
            secondSem:[
                ...
                {subjCode:"SAP323",subjName:"MIS with ERP (SAP B1)", duration: 3, classType: "lab", expertiseReq:"COmputer Science"},
                {subjCode:"GEC109",subjName:"Life and Works of Rizal", duration: 3, classType: "lec", expertiseReq:"General Education"},
            ]
            }
    ]},
