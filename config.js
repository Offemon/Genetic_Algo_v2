export const config = 
    ...
    populationSize: 20,                      //configuration for the population size.POPULATION SIZE MUST BE PERFECTLY DIVISIBLE BY 4.Recommended popsize is 500 for performance
    maxGenerations: 500,                      //configuration for the minimum number of generations
    ...
    elitePopPercentage: 0.2,                  //Values needs to be between o-1 (0% to 100%). suggested Value is 0.2(20%)
